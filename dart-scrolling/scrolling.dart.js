...
$$.ConstantMap = {"": "Object;length>,_jsObject,_liblib4$_keys",
  ...
  forEach$1: function(_, f) {
    $.forEach$1$ax(this._liblib4$_keys, new $.ConstantMap_forEach_anon(this, f));
  },
  get$keys: function() {
    return $._ConstantMapKeyIterable$(this);
  },
  get$values: function(_) {
    return $.map$1$ax(this._liblib4$_keys, new $.ConstantMap_values_anon(this));
  },
...
$$._FrozenElementListIterator = {"": "Object;_list,_liblib3$_index,_current",
  moveNext$0: function() {
    var nextIndex, t1;
    nextIndex = $.$add$ns(this._liblib3$_index, 1);
    t1 = this._list;
...
$$.CanvasScrolling = {"": "Object;_ctx,_canvas,_scrollPosition,_pressedKeys<,_scrollVelocity,_mapWidth,_mapHeight,_tileSize,_tileSpacing,_infoElements,_liblib2$_map,_palette,_paletteColumns,_running,tilemap",
  start$0: function(_) {
    this._running = true;
    $.requestAnimationFrame$1$x(window, this.get$_loop());
  },
  ...
  get$_loop: function() {
    return new $.BoundClosure$1(this, "_loop$1");
  },
  _updateScrollPosition$0: function() {
    var t1, t2, t3;
    t1 = this._pressedKeys;
    if (t1.contains$1(t1, "Up")) {
      t1 = this._scrollPosition;
      t1.set$y(t1, $.$sub$n(t1.y, this._scrollVelocity));
    }
    t1 = this._pressedKeys;
    if (t1.contains$1(t1, "Down")) {
      t1 = this._scrollPosition;
      t1.set$y(t1, $.$add$ns(t1.y, this._scrollVelocity));
    }
    t1 = this._pressedKeys;
    if (t1.contains$1(t1, "Left")) {
      t1 = this._scrollPosition;
      t1.set$x(t1, $.$sub$n(t1.x, this._scrollVelocity));
    }
    t1 = this._pressedKeys;
    if (t1.contains$1(t1, "Right")) {
      t1 = this._scrollPosition;
      t1.set$x(t1, $.$add$ns(t1.x, this._scrollVelocity));
    }
    if ($.$lt$n(this._scrollPosition.x, 0)) {
      t1 = this._scrollPosition;
      t1.set$x(t1, 0);
    }
    if ($.$lt$n(this._scrollPosition.y, 0)) {
      t1 = this._scrollPosition;
      t1.set$y(t1, 0);
    }
    t1 = this._scrollPosition;
    t2 = this._mapWidth;
    t3 = $.get$width$x(this._canvas);
    if (typeof t3 !== "number")
      throw $.iae(t3);
    if ($.$ge$n(t1.x, t2 - t3)) {
      t1 = this._scrollPosition;
  ...
  _info$2: function(id, value) {
    var t1;
    if (this._infoElements == null)
      this._infoElements = $.HashMap$();
    if (this._infoElements.containsKey$1(id) !== true) {
      t1 = this._infoElements;
      t1.$indexSet(t1, id, document.querySelector("#" + id));
    }
    t1 = this._infoElements;
    t1.$index(t1, id).set$innerHTML(value);
  },
  _draw$1: function(tick) {
    var tileWidth, mapTilesAcross, firstTileIndex, partialYpx, partialXpx, t1, t2, t3, t4, t5, row, y, tileHeight, tileIndex, t6, x, t7, tileWidth0, tileId, t9, paletteX, paletteY;
    $.clearRect$4$x(this._ctx, 0, 0, $.get$width$x(this._canvas), $.get$height$x(this._canvas));
    $.set$left$x(this._canvas.style, $.S(this._scrollPosition.x) + "px");
    $.set$top$x(this._canvas.style, $.S(this._scrollPosition.y) + "px");
    this._info$2("scrollPosition", "x: " + $.S(this._scrollPosition.x) + ", y: " + $.S(this._scrollPosition.y));
    tileWidth = this._tileSize;
    mapTilesAcross = $.JSDouble_methods.toInt$0(this._mapWidth / tileWidth);
    $.JSDouble_methods.toInt$0(this._mapHeight / tileWidth);
    firstTileIndex = $.JSNumber_methods.toInt$0($.$div$n(this._scrollPosition.y, tileWidth)) * mapTilesAcross + $.JSNumber_methods.toInt$0($.$div$n(this._scrollPosition.x, tileWidth));
    partialYpx = tileWidth - $.JSNumber_methods.toInt$0($.$mod$n(this._scrollPosition.y, tileWidth));
    partialXpx = tileWidth - $.JSNumber_methods.toInt$0($.$mod$n(this._scrollPosition.x, tileWidth));
    this._info$2("startingTile", "First Index: " + $.S(firstTileIndex));
    for (t1 = tileWidth - partialXpx, t2 = tileWidth - partialYpx, t3 = this.tilemap, t4 = this._paletteColumns, t5 = tileWidth + this._tileSpacing, row = 0, y = 0; $.JSNumber_methods.$lt(y, $.get$height$x(this._canvas));) {
      tileHeight = y === 0 ? partialYpx : tileWidth;
      tileIndex = mapTilesAcross * row + firstTileIndex;
      if (tileIndex !== (tileIndex | 0))
        return this._draw$1$bailout(1, firstTileIndex, partialYpx, partialXpx, tileIndex, tileHeight, t2, t3, t1, tileWidth, t4, t5, row, y, mapTilesAcross);
      if (tileIndex >= t3.length)
        break;
      for (t6 = tileHeight !== tileWidth, x = 0; $.JSNumber_methods.$lt(x, $.get$width$x(this._canvas));) {
        t7 = t3.length;
        if (tileIndex >= t7)
          break;
        tileWidth0 = x === 0 ? partialXpx : tileWidth;
        if (tileIndex < 0)
          throw $.ioore(tileIndex);
        tileId = t3[tileIndex];
        if (typeof tileId !== "number")
          return this._draw$1$bailout(2, firstTileIndex, partialYpx, partialXpx, tileIndex, tileHeight, t2, t3, t1, tileWidth, t4, t5, row, y, mapTilesAcross, t6, x, tileId, tileWidth0);
        t9 = tileId - 1;
        paletteX = $.JSNumber_methods.$mod(t9, t4) * t5;
        paletteY = $.JSNumber_methods.toInt$0(t9 / t4) * t5;
        if (t6)
          paletteY += t2;
        if (tileWidth0 !== tileWidth)
          paletteX += t1;
        this._info$2("rendering", "(" + $.S(paletteX) + "," + $.S(paletteY) + ") " + $.S(tileWidth0) + "x" + $.S(tileHeight) + " ---> (" + $.S(x) + "," + $.S(y) + ") " + $.S(tileWidth0) + "x" + $.S(tileHeight));
        $.drawImage$9$x(this._ctx, this._palette, paletteX, paletteY, tileWidth0, tileHeight, x, y, tileWidth0, tileHeight);
        ++tileIndex;
        x += tileWidth0;
      }
      y += tileHeight;
  ...
  _draw$1$bailout: function(state0, firstTileIndex, partialYpx, partialXpx, tileIndex, tileHeight, t2, t3, t1, tileWidth, t4, t5, row, y, mapTilesAcross, t6, x, tileId, tileWidth0) {
    switch (state0) {
      case 0:
        $.clearRect$4$x(this._ctx, 0, 0, $.get$width$x(this._canvas), $.get$height$x(this._canvas));
        $.set$left$x(this._canvas.style, $.S(this._scrollPosition.x) + "px");
        ...
        partialXpx = tileWidth - $.JSNumber_methods.toInt$0($.$mod$n(this._scrollPosition.x, tileWidth));
        this._info$2("startingTile", "First Index: " + $.S(firstTileIndex));
        t1 = tileWidth - partialXpx;
        t2 = tileWidth - partialYpx;
        t3 = this.tilemap;
        t4 = this._paletteColumns;
        t5 = tileWidth + this._tileSpacing;
        row = 0;
        y = 0;
      default:
        var t7, t9, paletteX, paletteY;
        L0:
          while (true)
            switch (state0) {
              case 0:
                if (!$.JSNumber_methods.$lt(y, $.get$height$x(this._canvas)))
                  break L0;
                tileHeight = y === 0 ? partialYpx : tileWidth;
                tileIndex = mapTilesAcross * row + firstTileIndex;
              case 1:
              ...
              case 2:
                L1:
                  while (true)
                    switch (state0) {
                      case 0:
                        if (!$.JSNumber_methods.$lt(x, $.get$width$x(this._canvas)))
                          break L1;
                        t7 = t3.length;
                        if (tileIndex >= t7)
                          break L1;
                        ...
                        if (tileIndex !== (tileIndex | 0))
                          throw $.iae(tileIndex);
                        if (tileIndex < 0 || tileIndex >= t7)
                          throw $.ioore(tileIndex);
                        tileId = t3[tileIndex];
                      case 2:
                        state0 = 0;
                        t9 = $.getInterceptor$n(tileId);
                        paletteX = $.$mod$n(t9.$sub(tileId, 1), t4) * t5;
                        paletteY = $.JSNumber_methods.toInt$0($.$div$n(t9.$sub(tileId, 1), t4)) * t5;
                        if (t6)
                          paletteY += t2;
                        if (tileWidth0 !== tileWidth)
                          paletteX += t1;
  ...
  CanvasScrolling$0: function() {
    var t1, t2, tileNum, y, x, html, t3;
    this._liblib2$_map = $.query$1$x($.document(), "#map");
    this._canvas = $.query$1$x($.document(), "#canvas");
    this._ctx = $.getContext$1$x(this._canvas, "2d");
    t1 = this._mapHeight;
    t2 = $.get$height$x(this._canvas);
    if (typeof t2 !== "number")
      throw $.iae(t2);
    this._scrollPosition = $.Point$(0, t1 - t2);
    this._pressedKeys = $.Set_Set();
    this._palette = $.ImageElement_ImageElement(null, "palette.png", null);
    $.add$1$ax($.get$on$x($.document()).get$keyDown(), new $.anon(this));
    $.add$1$ax($.get$on$x($.document()).get$keyUp(), new $.anon0(this));
    for (t2 = this._mapWidth, tileNum = 1, y = 0; y < t1; y += 32)
      for (x = 0; x < t2; x += 32) {
        html = "<div class=\"cell\" style=\"position: absolute; top: " + y + "px; left: " + x + "px; width: 32px; height: 32px;\">" + tileNum + "</div>";
        t3 = $.get$nodes$x(this._liblib2$_map);
        t3.add$1(t3, $.Element_Element$html(html));
        ++tileNum;
      }
  }
};
...
$$.anon = {"": "Closure;this_0",
  call$1: function($event) {
    var t1 = this.this_0.get$_pressedKeys();
    return t1.add$1(t1, $event.get$keyIdentifier());
  }
};

$$.anon0 = {"": "Closure;this_1",
  call$1: function($event) {
    var t1 = this.this_1.get$_pressedKeys();
    return t1.remove$1(t1, $event.get$keyIdentifier());
  }
};
...
$.main = function() {
  var t1 = $.CanvasScrolling$();
  return t1.start$0(t1);
};

$.CanvasScrolling$ = function() {
  var t1 = new $.CanvasScrolling(null, null, null, null, 2, 800, 500, 32, 1, null, null, null, 5, null, $.List_rEy);
  t1.CanvasScrolling$0();
  return t1;
};
...
$.drawImage$9$x = function(receiver, a0, a1, a2, a3, a4, a5, a6, a7, a8) {
  return $.getInterceptor$x(receiver).drawImage$9(receiver, a0, a1, a2, a3, a4, a5, a6, a7, a8);
};
...
$.$defineNativeClass("HTMLTextAreaElement", {"": "rows="});
...
(function() {
  ...
  $.dynamicSetMetadata([["CharacterData", v5_CharacterData], ["Document", v6_Document], ["DocumentFragment", v4_DocumentFragment], ["HTMLMediaElement", v1_MediaElement], ["SVGTextPositioningElement", v0_TextPositioningElement], ["SVGElement", v2_SvgElement], ["Element", v3_Element], ["Node", v7_Node], ["EventTarget", [v7_Node, "DOMWindow|EventTarget"].join("|")], ["HTMLCollection", "HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"], ["NodeList", "NodeList|RadioNodeList"], ["Uint8Array", "Uint8Array|Uint8ClampedArray"]]);
})();
...
//@ sourceMappingURL=scrolling.dart.js.map

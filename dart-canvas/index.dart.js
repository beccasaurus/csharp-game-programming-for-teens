...
$$.HashMapImplementation = {"":
 ...
 remove$1: function(key) {
  ...
  if ($.geB(index, 0)) {
    ...
    $.indexSet(this._lib0_keys, index, $.CTC6);
 ...
 operator$indexSet$2: function(key, value) {
  ...
  if ($.index(this._lib0_keys, index) == null || $.index(this._lib0_keys, index) === $.CTC6) this._numberOfEntries = $.add(this._numberOfEntries, 1);
...
$$.HashSetIterator = {"":
 ...
 hasNext$0$bailout: function(state, env0, env1) {
  ...
  switch (state) {
    ...
    case 2:
      state = 0;
      $.index(t1, this._nextValidIndex) === $.CTC6 && this._advance$0();
      t1 = this._nextValidIndex;
      t2 = $.get$length(this._entries);
    case 3:
      state = 0;
...
$$.LinkedHashMapImplementation = {"":
 ...
 operator$indexSet$2: function(key, value) {
  if (this._map.containsKey$1(key) === true) {
    ...
    $.addLast(this._list, $.KeyValuePair$(key, value));
    t1 = this._map;
...
$$.DoubleLinkedQueue = {"":
 ...
 every$1: function(f) {
  ...
  for (; t1 = this._sentinel, !(entry == null ? t1 == null : entry === t1); ) {
    ...
    if (f.$call$1(entry.get$_lib0_element()) !== true) return false;
    entry = nextEntry;
  }
  return true;
  var t1;
...
$$.Direction = {"":
 ["keys?", "yVelocity?", "xVelocity?", "name?"],
 super: "Object",
 toString$0: function() {
  return this.name;
 },
 hashCode$0: function() {
  return $.indexOf$1($.CTC23, this);
 }
};

$$.Game = {"":
 ["_lastTick", "fps", "imagesToLoad", "keysPressed?", "background", "player?", "sprites?", "images?", "stopped", "paused", "runLoop", "_doneLoading", "height=", "width=", "canvas", "ctx?", "doc"],
 super: "Object",
 drawBackground$0: function() {
  this.ctx.drawImage$5($.index(this.images, 'grass.bmp'), 0, 0, this.width, this.height);
 },
 clearCanvas$0: function() {
  return this.ctx.clearRect$4(0, 0, this.width, this.height);
 },
 draw$1: function(tick) {
  this.clearCanvas$0();
  this.drawBackground$0();
  var t1 = this.ctx;
  var t2 = 'FPS: ' + $.S(this.fps);
  var t3 = this.height;
  if (typeof t3 !== 'number') return this.draw$1$bailout(1, tick, t3, t2, t1);
  t1.fillText$3(t2, 10, t3 - 10);
  for (t1 = $.iterator(this.sprites); t1.hasNext$0() === true; ) {
    t1.next$0().draw$1(tick);
  }
  this.player.draw$1(tick);
 },
 draw$1$bailout: function(state, tick, t3, t2, t1) {
  t1.fillText$3(t2, 10, $.sub(t3, 10));
  for (t1 = $.iterator(this.sprites); t1.hasNext$0() === true; ) {
    t1.next$0().draw$1(tick);
  }
  this.player.draw$1(tick);
 ...
 update$1: function(tick) {
  for (var t1 = $.iterator(this.sprites); t1.hasNext$0() === true; ) {
    t1.next$0().update$1(tick);
  }
  this.player.update$1(tick);
 },
 loop$1: function(tick) {
  this.saveFPS$1(tick);
  if (this.runLoop === true) {
    if (this.get$doneLoading() === true) {
      this.paused !== true && this.update$1(tick);
      this.draw$1(tick);
    }
 ...
 saveFPS$1: function(tick) {
  if (this._lastTick == null) this._lastTick = tick;
  var t1 = $.sub(tick, this._lastTick);
 ...
 stop$0: function() {
  this.runLoop = false;
  $.indexSet($.document().query$1('#stopped').get$dataAttributes(), 'enabled', true);
 },
 start$0: function() {
  this.runLoop = true;
  $.indexSet($.document().query$1('#stopped').get$dataAttributes(), 'enabled', this.runLoop !== true);
  $.window().requestAnimationFrame$1(this.get$loop());
 },
 togglePaused$0: function() {
  this.paused = this.paused !== true;
  $.indexSet($.document().query$1('#paused').get$dataAttributes(), 'enabled', this.paused);
 },
 toggleLoop$0: function() {
  if (this.runLoop === true) this.stop$0();
  else this.start$0();
 },
 onKeyDown$1: function(event$) {
  this.log$1('Pressed key: ' + $.S(event$.get$keyIdentifier()));
  if ($.eqB(event$.get$keyIdentifier(), 'U+001B')) this.toggleLoop$0();
  else {
    if ($.eqB(event$.get$keyIdentifier(), 'U+0050')) this.togglePaused$0();
    else {
      if ($.eqB(event$.get$keyIdentifier(), 'U+0020')) this.player.shoot$0();
      else $.add$1(this.keysPressed, event$.get$keyIdentifier());
    }
  }
 },
 onKeyUp$1: function(event$) {
  this.log$1('UP: ' + $.S(event$.get$keyIdentifier()));
  this.keysPressed.remove$1(event$.get$keyIdentifier());
 },
 onLoaded$0: function() {
  $.add$1($.document().get$on().get$keyUp(), new $.Game_onLoaded_anon(this));
  $.add$1($.document().get$on().get$keyDown(), new $.Game_onLoaded_anon0(this));
  this.log$1('Loading Complete.');
 },
 get$doneLoading: function() {
  if (this._doneLoading === true) return true;
  this._doneLoading = $.every(this.images.getValues$0(), new $.Game_doneLoading_anon());
  this._doneLoading === true && this.onLoaded$0();
  return this._doneLoading;
 },
 load$0: function() {
  this.ctx.fillText$3('Loading ...', 10, 10);
  this.images = $.HashMapImplementation$();
  for (var t1 = $.iterator(this.imagesToLoad); t1.hasNext$0() === true; ) {
    var t2 = t1.next$0();
    this.log$1('loading ' + $.S(t2) + ' ...');
    $.indexSet(this.images, t2, $._Elements_ImageElement('assets/' + $.S(t2), null, null));
    $.add$1($.index(this.images, t2).get$on().get$load(), new $.Game_load_anon(t2, this));
  }
 },
 get$load: function() { return new $.BoundClosure0(this, 'load$0'); },
 log$1: function(msg) {
  return $.window().get$console().log$1(msg);
 },
 Game$0: function() {
  ...
  $.setRuntimeTypeInfo(t1, ({E: 'String'}));
  this.keysPressed = t1;
  this.player = $.Player$($.ArcherSprite$(50, 100, this), null);
  t1 = $.ArrowSprite$(this);
  this.player.set$arrow(t1);
  t1 = $.ListFactory_List(null);
  $.setRuntimeTypeInfo(t1, ({E: 'Sprite'}));
  this.sprites = t1;
  this.sprites.push(this.player.get$arrow());
  this.sprites.push($.ZombieSprite$(5, 5, this));
  this.load$0();
 }
};

$$.Sprite = {"":
 ["alive!", "_animate!", "height=", "width=", "y=", "x=", "image?", "game?"],
 super: "Object",
 collidesWith$1: function(other) {
  return $.Sprite_areColliding(this, other);
 },
 move$0: function() {
  for (; $.gtB(this.moves, 0); ) {
    this.moves = $.sub(this.moves, 1);
    this.x = $.add(this.x, $.mul(this.get$direction().get$xVelocity(), this.speed));
    this.y = $.add(this.y, $.mul(this.get$direction().get$yVelocity(), this.speed));
    if ($.gtB(this.x, this.get$xMax())) this.x = this.get$xMax();
    if ($.ltB(this.x, 0)) this.x = 0;
    if ($.gtB(this.y, this.get$yMax())) this.y = this.get$yMax();
    if ($.ltB(this.y, 0)) this.y = 0;
  }
 },
 get$yMax: function() {
  return $.sub(this.game.get$height(), this.height);
 },
 get$xMax: function() {
  return $.sub(this.game.get$width(), this.width);
 },
 calculateAnimationFrame$0: function() {
  var t1 = this._animationFrame;
  var t2 = this.width;
  if (typeof t2 !== 'number') throw $.iae(t2);
  this.animationX = t1 * t2;
  this.animationY = this.frameRows == null ? 0 : $.mul($.indexOf$1(this.frameRows, this.get$direction()), this.height);
 },
 animate$1: function(tick) {
  if ($.gtB(tick, $.add(this._lastTick, this.animationRate))) {
    this._lastTick = tick;
    this._animationFrame = this._animationFrame + 1;
    if ($.geB(this._animationFrame, this.frameColumns)) {
      this._lastTick = 0;
      this._animationFrame = 0;
      !(this._afterAnimate == null) && this._afterAnimate$0();
    }
  }
 },
 animateOnce$1: function(callback) {
  this.game.log$1('got callback ' + $.S(callback));
  this._animate = true;
  this._afterAnimate = new $.Sprite_animateOnce_anon(this, callback);
 },
 onDamage$1: function(projectile) {
  this.game.log$1('onDamage!');
  this.alive = false;
 },
 update$1: function(tick) {
  if (this.alive !== true) return;
  this.projectile === true && $.forEach(this.game.get$sprites(), new $.Sprite_update_anon(this));
  if (!(this.movesPerTick == null)) {
    var t1 = this.moves;
    if (typeof t1 !== 'number') return this.update$1$bailout(1, tick, t1, 0);
    var t2 = this.movesPerTick;
    if (typeof t2 !== 'number') return this.update$1$bailout(2, tick, t1, t2);
    this.moves = t1 + t2;
  }
  this._animate === true && this.animate$1(tick);
  this.calculateAnimationFrame$0();
  t1 = this.moves;
  if (typeof t1 !== 'number') return this.update$1$bailout(3, t1, 0, 0);
  t1 > 0 && this.move$0();
 },
 update$1$bailout: function(state, env0, env1, env2) {
  switch (state) {
    case 1:
      var tick = env0;
      t1 = env1;
  ...
  switch (state) {
    ...
    case 1:
    case 2:
      if (state == 1 || state == 2 || (state == 0 && !(this.movesPerTick == null))) {
        switch (state) {
          case 0:
            var t1 = this.moves;
          case 1:
    ...
    case 3:
      state = 0;
      $.gtB(t1, 0) && this.move$0();
  }
 },
 draw$1: function(tick) {
  if (this.alive !== true) return;
  var t1 = this.get$images();
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return this.draw$1$bailout(1, t1);
  var t2 = this.image;
  if (t2 !== (t2 | 0)) throw $.iae(t2);
  var t3 = t1.length;
  if (t2 < 0 || t2 >= t3) throw $.ioore(t2);
  t2 = t1[t2];
  this.get$ctx().drawImage$9(t2, this.animationX, this.animationY, this.width, this.height, this.x, this.y, this.width, this.height);
 },
 draw$1$bailout: function(state, t1) {
  var img = $.index(t1, this.image);
  this.get$ctx().drawImage$9(img, this.animationX, this.animationY, this.width, this.height, this.x, this.y, this.width, this.height);
 },
 get$images: function() {
  return this.game.get$images();
 },
 get$ctx: function() {
  return this.game.get$ctx();
 },
 log$1: function(msg) {
  return this.game.log$1(msg);
 },
 set$direction: function(dir) {
  if (!(dir == null)) {
    this.moves = 1;
    this._direction = dir;
  }
 ...
 _afterAnimate$0: function() { return this._afterAnimate.$call$0(); },
 Sprite$15: function(game, image, x, y, width, height, frameColumns, frameRows, animationRate, direction, speed, movesPerTick, alive, projectile, animate) {
  this.game = game;
  this.image = image;
  this.x = x;
  this.y = y;
  ...
  this.speed = speed;
  this._direction = !(direction == null) ? direction : $.CTC10;
...
$$.Player = {"":
 ...
 super: "Object",
 draw$1: function(tick) {
  return this.sprite.draw$1(tick);
 },
 updateDirection$0: function() {
  var t1 = $.ListFactory_List$from(this.sprite.get$game().get$keysPressed());
  $.setRuntimeTypeInfo(t1, ({E: 'KeyName'}));
  t1 = $.Direction_fromKeys(t1);
  this.sprite.set$direction(t1);
  return t1;
 },
 update$1: function(tick) {
  this.updateDirection$0();
  this.sprite.update$1(tick);
 },
 shoot$0: function() {
  return this.sprite.animateOnce$1(new $.Player_shoot_anon(this));
 },
 Player$2: function(sprite, arrow) {
  this.sprite = sprite;
  this.arrow = arrow;
 }
};
...
$$.ArcherSprite = {"":
 ["alive", "movesPerTick", "moves", "_lastTick", "_animationFrame", "_afterAnimate", "_animate", "projectile", "speed", "_direction", "animationRate", "frameColumns", "frameRows", "height", "width", "animationY", "animationX", "y", "x", "image", "game"],
 super: "Sprite"
};
...
$$.ArrowSprite = {"":
 ...
 super: "Sprite",
 move$0: function() {
  $.Sprite.prototype.move$0.call(this);
  if ($.eqB(this.x, 0) || ($.eqB(this.y, 0) || ($.eqB(this.x, this.get$xMax()) || $.eqB(this.y, this.get$yMax())))) this.alive = false;
 },
 calculateAnimationFrame$0: function() {
  var xAndY = $.index($.ArrowSprite_animationFramesByDirection(), this.get$direction());
  this.animationX = $.mul($.index(xAndY, 0), this.width);
  this.animationY = $.mul($.index(xAndY, 1), this.height);
 }
};
...
$$.ZombieSprite = {"":
 ...
 move$0: function() {
  $.Sprite.prototype.move$0.call(this);
  if ($.eqB(this.x, this.get$xMax())) this.set$direction($.CTC20);
  else {
    $.eqB(this.x, 0) && this.set$direction($.CTC8);
  }
 }
};
...
$$.Game_doneLoading_anon = {"":
 [],
 super: "Closure",
 $call$1: function(img) {
  return img.get$complete();
 }
};
...
$$.Game_onLoaded_anon = {"":
 ...
 $call$1: function(event$) {
  return this.this_0.onKeyUp$1(event$);
 }
};
...
$$.Game_onLoaded_anon0 = {"":
 ...
 super: "Closure",
 $call$1: function(event$) {
  return this.this_1.onKeyDown$1(event$);
 }
};
...
$$.Game_load_anon = {"":
 ...
 super: "Closure",
 $call$1: function(event$) {
  this.this_0.log$1('loaded ' + $.S(this.image_1));
 }
};
...
$$.Sprite_update_anon = {"":
 ["this_0"],
 super: "Closure",
 $call$1: function(sprite) {
  if (!$.eqB(sprite, this.this_0) && !$.eqB(sprite, this.this_0.get$game().get$player())) {
    if (this.this_0.collidesWith$1(sprite) === true) {
      this.this_0.log$1('projectile ' + $.S(this.this_0.get$image()) + ' collides with other sprite: ' + $.S(sprite.get$image()) + ', arrow: ' + $.S(this.this_0.get$x()) + ' ' + $.S(this.this_0.get$y()) + ' and other: ' + $.S(sprite.get$x()) + ' ' + $.S(sprite.get$y()));
      this.this_0.log$1(sprite);
      this.this_0.log$1(this.this_0);
      sprite.onDamage$1(this.this_0);
      this.this_0.set$alive(false);
      return;
    }
  }
 }
...
$$.Player_shoot_anon = {"":
 ...
 super: "Closure",
 $call$0: function() {
  var t1 = this.this_0.get$sprite().get$direction();
  this.this_0.get$arrow().set$direction(t1);
  t1 = $.add(this.this_0.get$sprite().get$x(), 30);
  this.this_0.get$arrow().set$x(t1);
  t1 = $.add(this.this_0.get$sprite().get$y(), 30);
  this.this_0.get$arrow().set$y(t1);
  this.this_0.get$arrow().set$alive(true);
 }
};

$$.Sprite_animateOnce_anon = {"":
 ["this_1", "callback_0"],
 super: "Closure",
 $call$0: function() {
  !(this.callback_0 == null) && this.callback_0.$call$0();
  this.this_1.set$_animate(false);
 }
};

$$.Direction_fromKeys_anon = {"":
 ["keys_0"],
 super: "Closure",
 $call$1: function(key) {
  return $.gt($.indexOf$1(this.keys_0, key), -1);
 }
};
...
$.Sprite_areColliding = function(a, b) {
  return !($.ltB($.add(a.get$y(), a.get$height()), b.get$y()) || ($.gtB(a.get$y(), $.add(b.get$y(), b.get$height())) || ($.ltB($.add(a.get$x(), a.get$width()), b.get$x()) || $.gtB(a.get$x(), $.add(b.get$x(), b.get$width())))));
};
...
$.Player$ = function(sprite, arrow) {
  var t1 = new $.Player(null, null);
  t1.Player$2(sprite, arrow);
  return t1;
};
...
$.ArrowSprite_animationFramesByDirection = function() {
  if ($.ArrowSprite__animationFramesByDirection == null) {
    $.ArrowSprite__animationFramesByDirection = $.HashMapImplementation$();
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC10, [0, 0]);
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC8, [8, 0]);
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC16, [5, 1]);
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC20, [2, 2]);
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC12, [4, 0]);
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC22, [6, 2]);
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC14, [1, 1]);
    $.indexSet($.ArrowSprite__animationFramesByDirection, $.CTC18, [9, 1]);
  }
  return $.ArrowSprite__animationFramesByDirection;
};
...
$.every = function(receiver, f) {
  if ($.isJsArray(receiver) !== true) return receiver.every$1(f);
...
$.Collections_every = function(iterable, f) {
  for (var t1 = $.iterator(iterable); t1.hasNext$0() === true; ) {
    if (f.$call$1(t1.next$0()) !== true) return false;
  }
  return true;
};
...
$.Game$ = function() {
  var t1 = new $.Game(null, 0, $.CTC5, null, null, null, null, null, false, false, true, false, null, null, null, null, null);
  t1.Game$0();
  return t1;
};
...
$.ArrowSprite$ = function(game) {
  var t1 = new $.ArrowSprite(true, 0, 0, 0, 0, null, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t1.Sprite$15(game, 'arrow.png', 0, 0, 32, 32, 1, null, 60, null, 5, 1, false, true, false);
  return t1;
};
...
$.ArcherSprite$ = function(x, y, game) {
  var t1 = [$.CTC10, $.CTC12, $.CTC8, $.CTC14, $.CTC16, $.CTC18, $.CTC20, $.CTC22];
  var t2 = new $.ArcherSprite(true, 0, 0, 0, 0, null, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t2.Sprite$15(game, 'archer_attack.png', x, y, 96, 96, 10, t1, 60, null, 2, null, true, false, false);
  return t2;
};
...
$.ZombieSprite$ = function(x, y, game) {
  var t1 = [$.CTC10, $.CTC12, $.CTC8, $.CTC14, $.CTC16, $.CTC18, $.CTC20, $.CTC22];
  var t2 = new $.ZombieSprite(true, 0, 0, 0, 0, null, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t2.Sprite$15(game, 'zombie walk.png', x, y, 96, 96, 8, t1, 60, $.CTC8, 1, 1, true, false, true);
  return t2;
};
...
$.Direction_fromKeys = function(keys) {
  for (var t1 = $.iterator($.CTC23); t1.hasNext$0() === true; ) {
    var t2 = t1.next$0();
    if ($.every(t2.get$keys(), new $.Direction_fromKeys_anon(keys)) === true) return t2;
  }
  return;
};
...
$.getFunctionForTypeNameOf = function() {
  ...
  if ($.contains$1(userAgent, $.CTC24) === true) return $.typeNameInChrome;
...
$.CTC11 = Isolate.makeConstantList(['Up', 'Right']);
$.CTC17 = Isolate.makeConstantList(['Down', 'Left']);
$.CTC18 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC17, 1, -1, 'South West');
$.CTC6 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC24 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, 'Chrome|DumpRenderTree');
$.CTC12 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC11, -1, 1, 'North East');
$.CTC21 = Isolate.makeConstantList(['Up', 'Left']);
$.CTC22 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC21, -1, -1, 'North West');
$.CTC9 = Isolate.makeConstantList(['Up']);
$.CTC10 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC9, -1, 0, 'North');
$.CTC4 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^#[_a-zA-Z]\\w*$');
$.CTC19 = Isolate.makeConstantList(['Left']);
$.CTC20 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC19, 0, -1, 'West');
$.CTC13 = Isolate.makeConstantList(['Down', 'Right']);
$.CTC15 = Isolate.makeConstantList(['Down']);
$.CTC16 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC15, 1, 0, 'South');
$.CTC14 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC13, 1, 1, 'South East');
$.CTC7 = Isolate.makeConstantList(['Right']);
$.CTC8 = new Isolate.$isolateProperties.Direction(Isolate.$isolateProperties.CTC7, 0, 1, 'East');
$.CTC23 = Isolate.makeConstantList([Isolate.$isolateProperties.CTC12, Isolate.$isolateProperties.CTC22, Isolate.$isolateProperties.CTC14, Isolate.$isolateProperties.CTC18, Isolate.$isolateProperties.CTC10, Isolate.$isolateProperties.CTC16, Isolate.$isolateProperties.CTC8, Isolate.$isolateProperties.CTC20]);
$.CTC25 = new Isolate.$isolateProperties.Object();
$.CTC5 = Isolate.makeConstantList(['grass.bmp', 'archer_attack.png', 'zombie walk.png', 'arrow.png']);
...
$.ArrowSprite__animationFramesByDirection = null;
$._getTypeNameOf = null;
var $ = null;
Isolate.$finishClasses($$);
$$ = {};
...
$.$defineNativeClass('WebKitAnimation', ["name?", "direction?"], {
});
...
$.$defineNativeClass('HTMLImageElement', ["y?", "x?", "width=", "src!", "name?", "height=", "complete?"], {
});
...
$.$defineNativeClass('DOMWindow', ["name?", "length?", "console?"], {
